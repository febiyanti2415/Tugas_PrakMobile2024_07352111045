...
import 'package:bab4/widget/big_card.dart';
import 'package:bab4/widget/product_card.dart';
import 'package:bab4/widget/section_header.dart';
import 'package:bab4/widget/top_seller.dart';
import 'package:bab4/widget/top_service.dart';
          ...
          children: [
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Image.asset(
                      'assets/img/profil.png', // path gambar PNG 
                      fit: BoxFit.contain,
                    ),
                  ),
                ],
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ListView(
                      ...
                      children: [
                        TopSeller(
                            'assets/img/timnas.png', 'Jersey Indo', 4.9),
                        TopSeller(
                            'assets/img/barca.png', 'Jersey Barca', 4.9),
                        TopSeller(
                            'assets/img/argen.png', 'Jersey Argen', 4.9),
                        TopSeller(
                            'assets/img/miami.png', 'Jersey Miami', 4.9),
                      ],
                    ),
                  ),
                ],
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: const DecorationImage(
                                  image: AssetImage('assets/img/indo.jpeg'),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  const CircleAvatar(
                                    radius: 25,
                                    backgroundImage:
                                        AssetImage('assets/img/indo.jpeg'),
                                  ),
                          ...
                          children: [
                            Row(
                              children: [
                                CircleAvatar(
                                  backgroundImage:
                                      AssetImage('assets/img/argen.jpeg'),
                                ),
                                SizedBox(width: 8),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
            ...
            Container(
              ...
              child: GridView.count(
                ...
                children: [
                  ProductCard(
                    imagePath: 'assets/img/jersyhitam.png',
                    productName: 'jersey Hitam',
                    productPrice: 'Rp 150.000',
                  ),
                  ProductCard(
                    imagePath: 'assets/img/jersyputih.png',
                    productName: 'Jersey Putih',
                    productPrice: 'Rp 150.000',
                  ),
                  ProductCard(
                    imagePath: 'assets/img/jaketmerah.png',
                    productName: 'Jaket Timnas',
                    productPrice: 'Rp 200.000',
                  ),
                  ProductCard(
                    imagePath: 'assets/img/jakethitam.png',
                    productName: 'Jaket Timnas',
                    productPrice: 'Rp 200.000',
                  ),
                ],
